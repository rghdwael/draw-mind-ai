...
export default function AddChildScreen() {
  ...
  const handleSave = async () => {
    if (!name.trim() || !age.trim() || !addChild) return;
    setLoading(true);

    try {
      // حماية الـ Haptics لتعمل على الهواتف فقط وتتجنب انهيار الويب
      if (Platform.OS !== "web") {
      ...
      console.error("Error inside handleSave child:", error);
    } finally {
      setLoading(false);
    }
  };
        ...
        <View style={styles.form}>
          <View style={styles.fieldGroup}>
            ...
            <View style={styles.inputWrap}>
              <Ionicons name="person-outline" size={18} color="#A090B8" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
          ...
          <View style={styles.fieldGroup}>
            ...
            <View style={styles.inputWrap}>
              <Ionicons name="calendar-outline" size={18} color="#A090B8" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
          ...
          <View style={styles.fieldGroup}>
            ...
            <View style={styles.inputWrap}>
              <Ionicons name="star-outline" size={18} color="#A090B8" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
...
const styles = StyleSheet.create({
  ...
  avatarPreviewWrap: { alignItems: "center", paddingVertical: 20 },
  avatarPreview: { width: 96, height: 96, borderRadius: 48, alignItems: "center", justifyContent: "center", marginBottom: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.18, shadowRadius: 12, elevation: 6 },
  avatarInitials: { fontSize: 32, fontWeight: "700", color: "#fff", fontFamily: "Inter_700Bold" },
  avatarLabel: { fontSize: 14, color: "#A090B8", marginBottom: 12, fontFamily: "Inter_500Medium" },
